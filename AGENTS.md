...
- `src/lib/ha` is vendored Home Assistant helper code and is excluded from normal app TypeScript and ESLint checks. Avoid editing it unless the task specifically requires it.
